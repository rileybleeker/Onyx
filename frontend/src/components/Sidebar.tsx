...
const nav = [
  ...
  { href: "/eight-sleep", label: "Eight Sleep", shortcut: "E", icon: "M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" },
