...
| `SCHEMA_DDL.md` | Production schema state pulled from Supabase: 85 indexes, 49 RLS policies, 1 FK, 30+ triggers, 14 views | 3 |
| `*_schema.sql` (10 files) | Canonical "intended" DDL per data source | 4 — reference as needed |
| `sql/*.sql` (21 files) | Migrations, view definitions, RLS, triggers, ADR-0001 attribution rollout | 4 — reference as needed |
